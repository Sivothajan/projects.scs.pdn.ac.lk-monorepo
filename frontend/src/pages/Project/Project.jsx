    ...
    <div className={projectStyle.project}>
      ...
      <div className={projectStyle.details}>
        ...
        <ul className={projectStyle.detailsList}>
          ...
          <li className={projectStyle.detailItem}>
            <strong>Course Code:</strong> {projectDetails.courseCode}
          </li>
          <li className={projectStyle.detailItem}>
            {Array.isArray(projectDetails.instructor) ? (
              ...
              <>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={projectStyle.instructor}
                >
          ...
          <li className={projectStyle.detailItem}>
            <strong>Academic Year:</strong> {projectDetails.academicYear}
          </li>
          <li className={projectStyle.detailItem}>
          ...
          <li className={projectStyle.detailItem}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={projectStyle.projectLink}
            >
              View Project
            </a>
          </li>
          ...
          {projectDetails.authors.map((author, index) => (
            <li key={index} className={projectStyle.authorItem}>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={projectStyle.authorLink}
              >
                {author.name}
              </a>
            </li>
