  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.description}>
        Welcome to the SCS Projects Portal documentation. This guide covers essential
      ...
      <ul className={styles.list}>
        <li><code className={styles.code}>npm run dev:frontend</code> - Frontend only</li>
        <li><code className={styles.code}>npm run dev:backend</code> - Backend only</li>
      </ul>
      ...
      <ul className={styles.list}>
        ...
        <li>API Documentation: <code className={styles.code}>http://localhost:3000/docs</code></li>
      </ul>
      ...
      <footer className={styles.footer}>
        <p className={styles.authorStamp}>
          © {new Date().getFullYear()} Department of Statistics & Computer Science, University of Peradeniya
          <br />
          <a
            href="https://github.com/sivothajan/projects.scs.pdn.ac.lk-monorepo"
            className={styles.link}
