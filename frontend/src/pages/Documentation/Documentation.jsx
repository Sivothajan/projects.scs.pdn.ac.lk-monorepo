  ...
  return (
    <div className={styles.container}>
      ...
      <p className={styles.description}>
        Welcome to the comprehensive documentation for the SCS Projects Portal.
        This guide provides detailed information about the project structure,
        setup procedures, and usage guidelines.
      </p>
      ...
      <ul className={styles.list}>
        ...
        <li>
          <a href="#development" className={styles.link}>
            Development
          </a>
        </li>
        <li>
          <a href="#api-documentation" className={styles.link}>
            API Documentation
          </a>
        </li>
        <li>
          <a href="#testing" className={styles.link}>
            Testing
          </a>
        </li>
        <li>
          <a href="#contributing" className={styles.link}>
            Contributing
          </a>
        </li>
        <li>
      ...
      <h2 id="introduction" className={styles.subtitle}>
        Introduction
      </h2>
      <p className={styles.text}>
        The SCS Projects Portal is a comprehensive platform designed for the
        Department of Statistics & Computer Science, Faculty of Science,
        University of Peradeniya. It serves as a central hub for student
        projects, facilitating collaboration, documentation, and showcase of
        academic work in statistics and computer science. The platform consists
        of a React-based frontend and a Node.js backend, providing a modern and
        scalable architecture.
      </p>

      <h2 id="installation" className={styles.subtitle}>
        Installation
      </h2>
      <p className={styles.text}>
        ...
        <ul className={styles.list}>
          <li>
            ...
            <span className={styles.envDescription}>
              Base URL for backend API (Default: http://localhost:3000)
            </span>
          </li>
          <li>
          ...
          <li>
            ...
            <span className={styles.envDescription}>
              Public URL of the frontend (Default: http://localhost:5173)
            </span>
          </li>
        </ul>
      ...
      <h2 id="development" className={styles.subtitle}>
        Development
      </h2>
      ...
      <p className={styles.text}>
        The development server supports hot reloading for both frontend and
        backend changes.
      </p>

      <h2 id="api-documentation" className={styles.subtitle}>
        API Documentation
      </h2>
      <p className={styles.text}>
      ...
      <div className={styles.apiEndpoints}>
        ...
        <ul className={styles.list}>
          <li>
            <code className={styles.code}>GET /api/projects</code> - List all
            projects
          </li>
          <li>
            <code className={styles.code}>GET /api/projects/:id</code> - Get
            project details
          </li>
          <li>
            <code className={styles.code}>POST /api/projects</code> - Create new
            project
          </li>
        </ul>
        ...
        <ul className={styles.list}>
          <li>
            <code className={styles.code}>GET /api/users</code> - List all users
          </li>
          <li>
            <code className={styles.code}>GET /api/users/:id</code> - Get user
            details
          </li>
        </ul>
      </div>

      <h2 id="testing" className={styles.subtitle}>
        Testing
      </h2>
      <p className={styles.text}>
        The project includes comprehensive testing suites for both frontend and
        backend:
      </p>
      ...
      <p className={styles.text}>
        For manual testing, access these URLs after starting the development
        servers:
      </p>
      <ul className={styles.list}>
        <li>
        ...
        <li>
          API Documentation:{" "}
          <code className={styles.code}>http://localhost:3000/api-docs</code>
        </li>
      </ul>

      <h2 id="contributing" className={styles.subtitle}>
        Contributing
      </h2>
      <p className={styles.text}>
      ...
      <ol className={styles.orderedList}>
        ...
        <li>
          Commit your changes:{" "}
          <code className={styles.code}>git commit -m 'Add some feature'</code>
        </li>
        <li>
          Push to the branch:{" "}
          <code className={styles.code}>
      ...
      <p className={styles.text}>
        ...
        <a
          href="https://gh.sivothajan.me/projects.scs.sivothajan.me"
          target="_blank"
      ...
      <h2 id="license" className={styles.subtitle}>
        License
      </h2>
      <p className={styles.text}>
      ...
      <footer className={styles.footer}>
        <p className={styles.authorStamp}>
          ...
          <a
            href="https://sivothajan.me/#from-scs.projects.site"
            className={styles.link}
          >
            Sivothayan
          </a>
